...
Seja bem-vindo(a) ao meu perfil! Sou graduando em Sistemas de Informação no Instituto Federal de Educação, Ciência e Tecnologia Baiano - Campus Itapetinga e um desenvolvedor apaixonado por engenharia de software e soluções tecnológicas. Atuo na criação de aplicativos móveis, estruturação de bancos de dados, desenvolvimento de sistemas web robustos, animações 3D, desenvolvimento de jogos na Godot, manutenção de PCs e sistemas embarcados.
...
- 🧪 **[PixoLume](https://app-lumilab.vercel.app/)**: Aplicativo mobile de colorimetria, idealizado como uma ferramenta digital para auxiliar em análises químicas.
...
- **LinkedIn:** [Hugo Barros](https://www.linkedin.com/in/hugo-santos-barros-7b764b217)
...
- 🎓 **Acadêmico:** Graduando em Sistemas de Informação, sempre buscando integrar novos conhecimentos técnicos.
- 🎮 **Hobby:** Criação de jogos e modelagem 3D.
- 💡 **Interesses Atuais:** Arquitetura de bancos de dados relacionais, ambientes Linux e exploração de ferramentas de IA no fluxo de desenvolvimento.
